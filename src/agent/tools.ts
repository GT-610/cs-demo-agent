...
export const DEMO_TOOL_SPECS: ToolSpec[] = [
  ...
  },
  {
    ...
    description:
      "Return the players in the selected demo with Steam ID and initial team number.",
    inputSchema: objectSchema({}),
  },
  {
  ...
  },
  {
    ...
    description:
      "Return a host-aggregated round summary with winner, reason, kills, and available economy evidence.",
    inputSchema: objectSchema({}),
  },
  {
    name: "get_economy_analysis",
    description:
      "Return per-round team economy values and buy classifications for the selected demo.",
    inputSchema: objectSchema({}),
  },
];
